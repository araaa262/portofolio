...
```bash
git clone https://github.com/araaaa262/Portofolio.git
cd Portofolio
npm install
```
...
SELECT
  'developed by rasya. This project is open-source and free to use.',
  'rasya',
  'https://lufcjqjywyqdxwqapogh.supabase.co/storage/v1/object/public/profile-images/profile-images/1771939421615_xx2q8hgya6e.jpeg',
  true,
  now()
WHERE NOT EXISTS (
  SELECT 1
